...
contract StopOnRevertHandler is Test {
    ...
    function mintAndDepositCollateral(uint256 collateralSeed, uint256 amountCollateral) public {
        ...
        // ERC20Mock collateral = ERC20Mock(address(123));
    ...
    function redeemCollateral(uint256 collateralSend, uint256 amountCollateral) public {
        ERC20Mock collateral = _getCollateralFromSeed(collateralSend);
